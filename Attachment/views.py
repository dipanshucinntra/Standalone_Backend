...
def create(request):
    try:
        ...
        model=Attachment(File=attachmentsImage_url, LinkType=LinkType, Caption=Caption, LinkID=LinkID, CreateDate=CreateDate, CreateTime=CreateTime, UpdateDate=UpdateDate, UpdateTime=UpdateTime)
        model.save()
